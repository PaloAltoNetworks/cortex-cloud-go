...
.PHONY: help format tidy lint build work work-sync copyright-check copyright sec test test-unit test-acc docs tag clean
...
copyright-check: ## Check for missing copyright headers. Requires copywrite.
	@echo "Checking for missing file headers..."
	@copywrite headers --config .copywrite.hcl --plan

# Requires copywrite:
# go install github.com/hashicorp/copywrite
copyright: ## Add missing copyright headers to all files. Requires copywrite.
