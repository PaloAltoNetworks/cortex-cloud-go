...
// GetTrackingGUIDFromAzureResponse parses and returns the created/updated 
...
func (r CreateTemplateOrEditIntegrationInstanceResponse) GetTrackingGUIDFromAzureResponse() (string, error) {
