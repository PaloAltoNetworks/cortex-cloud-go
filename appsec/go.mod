...
require (
	...
	github.com/PaloAltoNetworks/cortex-cloud-go/enums v0.0.2-beta
	github.com/PaloAltoNetworks/cortex-cloud-go/internal/app v0.0.0
	github.com/stretchr/testify v1.10.0
)

require (
	github.com/PaloAltoNetworks/cortex-cloud-go v0.0.2-beta // indirect
	github.com/PaloAltoNetworks/cortex-cloud-go/errors v0.0.2-beta // indirect
	github.com/PaloAltoNetworks/cortex-cloud-go/log v0.0.2-beta // indirect
