...
//			assert.Equal(t, "/"+ListPoliciesEndpoint, r.URL.Path)
...
//			assert.Equal(t, "/"+CreatePolicyEndpoint, r.URL.Path)
//
...
//		handler := http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
//			assert.Equal(t, http.MethodGet, r.Method)
//			assert.Equal(t, "/"+GetPolicyByIDEndpoint+"/policy123", r.URL.Path)
//			w.WriteHeader(http.StatusOK)
...
//			assert.Equal(t, "/"+DeletePolicyEndpoint+"/policy123", r.URL.Path)
//			w.WriteHeader(http.StatusNoContent)
//		})
//		client, server := setupTest(t, handler)
//		defer server.Close()
//
//		deleteReq := types.DeletePolicyRequest{
//			Id: "policy123",
//		}
